...
Update these notes using: git log --pretty=format:'* %s' --topo-order --no-merges 3.9.0-pre-allcpufix..HEAD
...
[3.9.0-allcpufix-1]
* CB-8866: add "Mixed Platforms" and "Win32"; CB-8869: Remove Windows 8.0 from Windows Universal
